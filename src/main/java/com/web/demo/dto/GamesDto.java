...
public class GamesDto {
	...
	private String vga;
	private Set<ImageDataDto> imageDatas = new HashSet<ImageDataDto>(0);
...
//	private Set<SlideShow> slideShows = new HashSet<SlideShow>(0);
	...
	public Set<ImageDataDto> getImageDatas() {
		return imageDatas;
	}
	public void setImageDatas(Set<ImageDataDto> imageDatas) {
